...
export default function Login() {
    ...
    //   console.log(response)
      if (response.status == 200) {
            ...
            //se indicou que quer manter conectado (Lembrar meus dados de login X)
            if (data.manter){
    ...
    return (
        ...
        <section className="bg-gray-50 dark:bg-gray-900">
            ...
            <a className="flex items-center space-x-3 rtl:space-x-reverse">
                <img src="./logo2.png" className="h-40" alt="Flowbite Logo" />
                    ...
                    <div className="p-6 space-y-4 md:space-y-6 sm:p-8">
                        ...
                        onSubmit={handleSubmit(verificaLogin)}>
                            ...
                            <div className="flex items-center justify-between">
                                ...
                                <a href="#" className="text-sm font-medium text-primary-600 hover:underline dark:text-primary-500  text-blue-400 dark:text-blue-600">Esqueci minha senha</a>
                            </div>
                            <button type="submit" className="w-full text-white bg-blue-600 hover:bg-primary-700 focus:ring-4 focus:outline-none focus:ring-primary-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-primary-600 dark:hover:bg-primary-700 dark:focus:ring-primary-800">Entrar</button>
